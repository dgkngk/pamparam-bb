...
from tafunc import get_current_exchange_info, nvt_analysis
...
def index():
    if request.method == "GET":
        list = {"15min": "15MIN", "1hr": "1HOUR",
                "4hr": "4HOUR", "1d": "1DAY", "1min": "1MIN"}
...
@app.route("/trial")
def trial():
    #return get_current_exchange_info("BTCUSDT")
    return str(nvt_analysis("BTCUSDT"))
